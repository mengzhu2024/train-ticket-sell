...
export default {
  ...
  computed: {
                                                                                                                        zongjiage:{
                                                                                                                                                                                                                                                            get: function () {
        return 1*this.ruleForm.jiage*this.ruleForm.piaoshu
      }
    },
                                                                                      },
  created() {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `goupiaodingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.goupiaodingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
