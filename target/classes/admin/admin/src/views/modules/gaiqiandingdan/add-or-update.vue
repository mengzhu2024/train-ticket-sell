  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="订单编号" prop="dingdanbianhao">
              <el-input v-model="ruleForm.dingdanbianhao" 
                placeholder="订单编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="车次名称" prop="checimingcheng">
          <el-select  @change="checimingchengChange" v-model="ruleForm.checimingcheng" placeholder="请选择车次名称">
            <el-option
                v-for="(item,index) in checimingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.checimingcheng" label="车次名称" prop="checimingcheng">
          ...
          <el-form-item class="input" label="总价格" prop="zongjiage">
              <el-input v-model="ruleForm.zongjiage" 
                placeholder="总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="改签日期" prop="gaiqianriqi">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.gaiqianriqi" 
                type="datetime"
                placeholder="改签日期">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gaiqianriqi" label="改签日期" prop="gaiqianriqi">
              <el-input v-model="ruleForm.gaiqianriqi" 
                placeholder="改签日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjiage = true;
            continue;
	            	            ...
	            	            if(o=='gaiqianriqi'){
            this.ruleForm.gaiqianriqi = obj[o];
	    this.ro.gaiqianriqi = true;
            continue;
          }
	            	            if(o=='yonghuming'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                    ...
                    // 下二随
    checimingchengChange () {
      this.$http({
        url: `follow/checixinxi/checimingcheng?columnValue=`+ this.ruleForm.checimingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                if(data.data.chepai){
                this.ruleForm.chepai = data.data.chepai
                                                ...
                                                if(data.data.qidianzhan){
                this.ruleForm.qidianzhan = data.data.qidianzhan
              }
                                                if(data.data.zhongdianzhan){
                this.ruleForm.zhongdianzhan = data.data.zhongdianzhan
              }
                                                                                                                                                                                        } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `gaiqiandingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gaiqiandingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
