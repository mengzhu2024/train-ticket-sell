          ...
          <el-form-item class="input" label="票数" prop="piaoshu">
              <el-input v-model="ruleForm.piaoshu" 
                placeholder="票数" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.chepiaotupian" label="车票图片" prop="chepiaotupian">
          <file-upload
          tip="点击上传车票图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.chepiaotupian?ruleForm.chepiaotupian:''"
          @change="chepiaotupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.chepiaotupian" label="车票图片" prop="chepiaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.chepiaotupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="总价格" prop="zongjiage">
              <el-input v-model="ruleForm.zongjiage" 
                placeholder="总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="退票原因" prop="tuipiaoyuanyin">
          <el-input v-model="ruleForm.tuipiaoyuanyin" 
              placeholder="退票原因" clearable  :readonly="ro.tuipiaoyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="退票原因" prop="tuipiaoyuanyin">
              <el-input v-model="ruleForm.tuipiaoyuanyin" 
                placeholder="退票原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.piaoshu = true;
            continue;
	            	            ...
	            	            if(o=='chepiaotupian'){
            this.ruleForm.chepiaotupian = obj[o];
	    this.ro.chepiaotupian = true;
            continue;
          }
	            	            if(o=='zongjiage'){
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `tuipiaodingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuipiaodingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                        ...
                                                                        chepiaotupianUploadChange(fileUrls) {
                this.ruleForm.chepiaotupian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                                                        	addEditStyleChange() {
	  this.$nextTick(()=>{
